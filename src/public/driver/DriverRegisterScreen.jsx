...
const DriverRegisterScreen = ({ navigation }) => {
  ...
  const { signInWithPhone } = useDriverAuth();
  ...
  const handleSendOTP = async () => {
    ...
    try {
      ...
      const formattedNumber = `+63${phoneNumber}`;
      const confirmation = await signInWithPhone(phoneNumber);

      // Only pass the verificationId and phone number
      navigation.navigate("DriverOtpVerification", {
        ...
        <SafeAreaView style={styles.container}>
          ...
          <View style={styles.mainContent}>
            <View style={styles.inputContainer}>
              <Text style={styles.label}>Register as an Angkol Rider</Text>
